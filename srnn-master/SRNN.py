...
#load data
#data_type = {"stars": np.float64, "data": np.str, "year": np.str}
df = pd.read_csv("yelp_2015.csv", nrows=20000)
#df = df.sample(5000)
...
glove_path = '/srnn-master/glove.6B/glove.6B.200d.txt'
embeddings_index = {}
...
savebestmodel = '/srnn-master/save_model/SRNN(8,2)_yelp2013.h5'
